    ...
    return (
        <>
            <div className='max-w-[1172px] mx-auto px-4' id='portfolio'>
                <div className='flex lg:flex-row flex-col-reverse max-lg:justify-center max-xl:items-center'>
                    ...
                    <div className='lg:w-7/12 w-full lg:pl-5 xl:pl-16 max-lg:flex justify-center items-center flex-col'>
                        <h2 className='text-black max-lg:text-center font-plus-sans !leading-127 font-semibold sm:mb-4 mb-3 md:mb-5 lg:text-4xxl md:text-5xl sm:text-4xl text-3xl'>How It Works?</h2>
                        <p className='max-w-[590px] max-lg:text-center font-plus-sans text-lg leading-160 max-lg:mx-auto mb-8'>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. Pregigt primasofi dede facebooka: förutom tivaligt. </p>
