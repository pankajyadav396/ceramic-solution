...
const WhatWeDo = () => {
    return (
        <>
            <div className='lg:mt-[140px] my-14 md:my-20 lg:mb-[116px]'>
                ...
                <div className=' max-w-[1178px] mx-auto px-4 max-sm:max-w-[364px] flex justify-center'>
                    <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5 lg:gap-6'>
                        {homeData.map((obj, index) => {
                            return (
                                <div key={index} className='px-[23px] py-6 border max-w-[364px] min-h-[470px] border-black hover:shadow-smallBlack duration-300 hover:border-transparent rounded-[24px] border-opacity-[12%]'>
