...
const WhatWeDo = () => {
    return (
        <>
            <div className='xl:mt-[140px] my-14 lg:my-20 md:my-16' id="about">
                ...
                <div className=' max-w-[1178px] mx-auto px-4 max-sm:max-w-[450px] flex justify-center'>
                    <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5 lg:gap-6'>
                        {homeList.map((obj, index) => {
                            return (
                                <div key={index} className='p-6 max-w-[450px] w-full sm:max-w-[364px] xl:min-h-[470px] outline outline-light-grey outline-1 hover:shadow-small-black duration-300 hover:outline-transparent rounded-[24px] border-opacity-[12%]'>
