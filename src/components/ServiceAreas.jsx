    ...
    return (
        <>
            <div className='max-w-[1172px] mx-auto px-3 xl:mt-[140px] lg:mt-20 md:mt-16 mt-14' id='services'>
                <h2 className='text-black font-plus-sans font-semibold !leading-127 mb-5 lg:text-4xxl md:text-5xl sm:text-4xl capitalize text-3xl'>We provide services <span className='block'> in these areas</span></h2>
