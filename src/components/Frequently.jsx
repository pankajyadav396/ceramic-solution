...
const Accordion = ({ items }) => {
    ...
    return (
        <div className="max-w-[912px] px-3 mx-auto lg:mt-[140px] md:mt-20 sm:mt-16 mt-14">
            <h2 className='text-black text-center font-plusSans !leading-127 font-semibold mb-5 lg:text-4xxl md:text-5xl sm:text-4xl text-3xl'>Frequently Asked Questions</h2>
            ...
            {accordionData.map((item, index) => (
                <div key={index} className="shadow-xsmBlack mb-6 rounded-2xl">
                    <button className="w-full flex justify-between gap-5 items-center p-4 sm:p-[21.6px_20px] rounded-2xl"
                        ...
                        <p className='text-lg font-plusSans font-normal text-start leading-160 max-sm:text-base'>{item.title}</p>
                    ...
                    <div
                        ...
                        <div className="p-4 pt-0">
                            <p className="text-black opacity-85 font-plusSans font-normal text-base">{item.content}</p>
                        </div>
                    </div>
                </div>
            ))}
