        ...
        <>
            <div className='lg:py-[100px] py-14 sm:py-16 md:py-20  bg-lightPink'>
                <div className=' max-w-[1172px] mx-auto px-4 flex justify-center items-center flex-col'>
                    <h2 className='text-black font-plusSans font-semibold mb-5 lg:text-4xxl md:text-5xl sm:text-4xl !leading-127 text-3xl text-center'>Our Process</h2>
                    ...
                    <div className='w-full max-lg:relative items-center max-lg:flex justify-center'>
                        <div className='flex flex-col lg:flex-row lg:top-0 sm:justify-between max-sm:translate-x-0 max-sm:w-full sm:h-[80%] md:w-full max-w-[875px] mx-auto max-lg:left-0 max-sm:top-0 max-sm:h-[80%] lg:mb-9 max-lg:absolute relative z-[1]'>
                            <div className='bg-lightRed rounded-full !left-[43%] font-plusSans max-sm:absolute flex items-center font-semibold justify-center max-sm:w-[60px] max-sm:h-[60px] sm:w-[74px] sm:h-[74px] lg:w-[88px] lg:h-[88px] text-xl sm:text-2xl md:text-2xxl text-white'>
                                01
                            </div>
                            <div className='bg-lightRed rounded-full !left-[43%] font-plusSans max-sm:absolute top-[44%] flex items-center font-semibold justify-center max-sm:w-[60px] max-sm:h-[60px] sm:w-[74px] sm:h-[74px] lg:w-[88px] lg:h-[88px] text-xl sm:text-2xl md:text-2xxl text-white'>
                                02
                            </div>
                            <div className='bg-lightRed rounded-full !left-[43%] font-plusSans max-sm:absolute bottom-10 flex items-center font-semibold justify-center max-sm:w-[60px] max-sm:h-[60px] sm:w-[74px] sm:h-[74px] lg:w-[88px] lg:h-[88px] text-xl sm:text-2xl md:text-2xxl text-white'>
                                03
                            </div>
