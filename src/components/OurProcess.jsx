    ...
    return (
        <div className='xl:py-[100px] lg:py-20 py-14 md:py-16 bg-light-pink'>
            <div className=' max-w-[1172px] mx-auto px-4 flex justify-center items-center flex-col'>
                <h2 className='text-black font-plus-sans font-semibold mb-5 lg:text-4xxl md:text-5xl sm:text-4xl !leading-127 text-3xl text-center'>Our Process</h2>
                ...
                <div className='w-full max-lg:relative items-center max-lg:flex max-lg:justify-center'>
                    <div className='flex flex-col lg:flex-row lg:top-0 678:justify-between max-678:translate-x-0 max-678:w-full md:w-full 678:h-[80%] lg:w-[77%] mx-auto max-md:left-0 max-lg:left-12 max-678:top-0 max-678:h-[80%] lg:mb-9 relative max-lg:absolute z-[1]'>
                        <div className='bg-light-red rounded-full !left-[43%] font-plus-sans max-678:absolute flex items-center font-semibold justify-center max-678:w-[60px] max-678:h-[60px] 678:w-[74px] 678:h-[74px] lg:w-[78px] lg:h-[78px] xl:w-[88px] xl:h-[88px] text-xl 678:text-2xl md:text-2xxl text-white'>
                            01
                        </div>
                        <div className='bg-light-red rounded-full !left-[43%] font-plus-sans max-678:absolute top-[44%] flex items-center font-semibold justify-center max-678:w-[60px] max-678:h-[60px] 678:w-[74px] 678:h-[74px] lg:w-[78px] lg:h-[78px] xl:w-[88px] xl:h-[88px] text-xl 678:text-2xl md:text-2xxl text-white'>
                            02
                        </div>
                        <div className='bg-light-red rounded-full !left-[43%] font-plus-sans max-678:absolute bottom-10 flex items-center font-semibold justify-center max-678:w-[60px] max-678:h-[60px] 678:w-[74px] 678:h-[74px] lg:w-[78px] lg:h-[78px] xl:w-[88px] xl:h-[88px] text-xl 678:text-2xl md:text-2xxl text-white'>
                            03
                        </div>
                    ...
                    <div className='grid lg:grid-cols-3 grid-cols-1 gap-6 max-678:gap-[120px] max-678:mt-[80px] relative z-[3]'>
                ...
                <div className=' text-center flex items-center justify-center mt-9'>
                    <PrimaryButton text="Get A Quote" className="bg-light-red text-white !leading-127 hover:text-light-red hover:bg-white hover:outline outline-[1px] hover:outline-light-red" />
                </div>
            </div>
        </div>
    )
