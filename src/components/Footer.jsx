                            ...
                            <div className='flex flex-wrap md:justify-between'>
                                <div className='md:w-2/12 max-[450px]:w-6/12 w-4/12'>
                                    <ul>
                                        ...
                                        <li className='mb-3'><a href="#home" className='capitalize hover:after:w-[100%] hover:after:left-0 after:right-0 after:w-0 after:absolute after:bg-black after:h-[1.5px] relative after:bottom-[-2px] after:rounded-[15px] after:transition-all after:duration-300 after:ease-linear text-base font-plusSans font-normal leading-160'>home</a></li>
                                        <li className='mb-3'><a href="#about" className='capitalize hover:after:w-[100%] hover:after:left-0 after:right-0 after:w-0 after:absolute after:bg-black after:h-[1.5px] relative after:bottom-[-2px] after:rounded-[15px] after:transition-all after:duration-300 after:ease-linear text-base font-plusSans font-normal leading-160'>about us</a></li>
                                        <li className='mb-3'><a href="#services" className='capitalize hover:after:w-[100%] hover:after:left-0 after:right-0 after:w-0 after:absolute after:bg-black after:h-[1.5px] relative after:bottom-[-2px] after:rounded-[15px] after:transition-all after:duration-300 after:ease-linear text-base font-plusSans font-normal leading-160'>Services</a></li>
                                        <li><a href="#Request" className='capitalize hover:after:w-[100%] hover:after:left-0 after:right-0 after:w-0 after:absolute after:bg-black after:h-[1.5px] relative after:bottom-[-2px] after:rounded-[15px] after:transition-all after:duration-300 after:ease-linear text-base font-plusSans font-normal leading-160'>Showcase</a></li>
                                    </ul>
                                </div>
                                <div className='md:w-2/12 max-[450px]:w-6/12 w-4/12'>
                                    <ul>
