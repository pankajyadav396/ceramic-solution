                    ...
                    <div className='flex lg:flex-row flex-col flex-wrap justify-between'>
                        <div className='lg:w-2/12 w-full'>
                            <div className='flex flex-col'>
                                <a href="/"> <img src={logo} alt="logo" className='w-[175.59px] mb-5 cursor-pointer' /></a>
                            ...
                            <div className='flex flex-wrap md:justify-between'>
                                <div className='md:w-2/12 max-450:w-6/12 w-4/12'>
                                    <ul>
                                        ...
                                        <li className='mb-3'><a href="#home" className='capitalize text-dark-blue hover:after:w-full hover:after:left-0 after:right-0 after:w-0 after:absolute after:bg-dark-blue  after:h-[1.5px] relative after:bottom-[-2px] after:rounded-2xl after:transition-all after:duration-300 after:ease-linear text-base font-plus-sans font-normal leading-160'>home</a></li>
                                        <li className='mb-3'><a href="#about" className='capitalize text-dark-blue hover:after:w-full hover:after:left-0 after:right-0 after:w-0 after:absolute after:bg-dark-blue  after:h-[1.5px] relative after:bottom-[-2px] after:rounded-2xl after:transition-all after:duration-300 after:ease-linear text-base font-plus-sans font-normal leading-160'>about us</a></li>
                                        <li className='mb-3'><a href="#services" className='capitalize text-dark-blue hover:after:w-full hover:after:left-0 after:right-0 after:w-0 after:absolute after:bg-dark-blue  after:h-[1.5px] relative after:bottom-[-2px] after:rounded-2xl after:transition-all after:duration-300 after:ease-linear text-base font-plus-sans font-normal leading-160'>Services</a></li>
                                        <li><a href="#Request" className='capitalize text-dark-blue hover:after:w-full hover:after:left-0 after:right-0 after:w-0 after:absolute after:bg-dark-blue  after:h-[1.5px] relative after:bottom-[-2px] after:rounded-2xl after:transition-all after:duration-300 after:ease-linear text-base font-plus-sans font-normal leading-160'>Showcase</a></li>
                                    </ul>
                                </div>
                                <div className='md:w-2/12 max-[450px]:w-6/12 w-4/12'>
                                    <ul>
                                        ...
                                        <li className='mb-3'><a href="#contactus" className='capitalize text-dark-blue hover:after:w-full hover:after:left-0 after:right-0 after:w-0 after:absolute after:bg-dark-blue  after:h-[1.5px] relative after:bottom-[-2px] after:rounded-2xl after:transition-all after:duration-300 after:ease-linear text-base font-plus-sans font-normal leading-160'>terms of use</a></li>
                                ...
                                <div className='md:w-5/12 w-full max-md:mt-5'>
                                    <ul>
                                        ...
                                        <div className='border max-w-[340px] border-dark-blue border-opacity-15 p-[10px_10px_10px_25px] rounded-62 flex items-center justify-between'>
                                            <input type="email" className='w-[110px] !outline-none' placeholder='Your email ' />
                                            <button className='px-10 py-4 bg-light-red duration-300 hover:bg-white hover:text-light-red outline outline-[1px] hover:outline-light-red font-plus-sans text-base leading-[26px] font-semibold text-white rounded-62'>Subscribe</button>
                                        </div>
                                    </ul>
                                </div>
                            </div>
