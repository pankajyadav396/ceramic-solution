    ...
    return (
        <>
            <div className='bg-light-red pt-6 lg:min-h-[810px] pb-[59px]' id='home'>
                ...
                <div className='mx-auto max-w-[1172px] lg:px-5 px-4 md:mt-16 mt-10 lg:mt-[79px] '>
                    ...
                    <div className='md:mt-12 xl:mt-16 sm:mt-10 mt-8 flex gap-6 flex-wrap items-center max-sm:justify-center'>
                        <div className=' flex gap-6 flex-wrap items-center justify-center'>
                            <div className='bg-white h-[80px] hover:scale-105 hover:-translate-y-1 duration-300  rounded-2xl ps-4 border w-[229.17px] border-black gap-2.5 border-opacity-10 flex items-center justify-start'>
                                ...
                                <div className=' flex flex-col'>
                                    ...
                                    <p className=' text-xsm font-normal mt-[-2px] leading-160 text-light-black font-manrop'>Based on 145 reviews</p>
                                </div>
                            </div>
                            <div className='bg-white h-[80px] hover:scale-105 hover:-translate-y-1 duration-300 rounded-2xl ps-2 border w-[229.17px] border-black gap-1 border-opacity-10 flex items-center justify-start'>
                        ...
                        <img src={certified} alt="certified-img" className=' hover:scale-105 hover:-translate-y-1 duration-300 w-[80px] h-[80px]' />
                        <img src={quality} alt="certified-img" className=' hover:scale-105 hover:-translate-y-1 duration-300 w-[80px] h-[80px]' />
                    </div>
                </div>
